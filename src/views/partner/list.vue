...
export default {
  ...
  beforeCreate() {
    ...
    this.delUrl = '/partner/delPartner';
  },
  created() {
    this.fetchRoles();
  },
  methods: {
    async init() {
      ...
      const { data, page: { counts } } = await this.apiPost('/partner/qryPartnerTree', { partnerid: this.currentpartnerid, pageSize: 10000 });
      this.pagination.dataCount = counts;
      ...
      this.data = [{ partnername: '全部', children: [], id: null }].concat(this.listToTree(this.partnerid, data));
