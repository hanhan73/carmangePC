...
export default {
  ...
  methods: {
    ...
    handleSingleBind(sns) {
      this.$emit('handleBindDevice', { fenceid: this.params.fenceId, sns, fencetype: '0' });
    },
    handleBatchBind() {
      ...
      this.$emit('handleBindDevice', { fenceid: this.params.fenceId, sns: this.selection.map(i => i.sn).join(','), fencetype: '0' });
    },
