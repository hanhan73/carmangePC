<template>
  <div class="fence-wrapper">
    ...
    <NewBindDevice ref="newbinddevice" @handleBindDevice="(args) => $refs.addFence.open(args)"></NewBindDevice>
...
import NewBindDevice from './newbinddevice';
...
export default {
  ...
  methods: {
    ...
    handleNodeClick(data) {
      ...
      // this.$refs.newbinddevice.open(coordinates, this.currentArea);
    },
