<template>
  <div class="">
    <div class="m-b-5 ovf-hd fz-14 search-bar">
      ...
      <el-select size="mini" v-model="params.queryStoptimeMin" clearable placeholder="请选择停留时长">
        <el-option
...
export default {
  ...
  methods: {
    ...
    async getAll() {
      ...
      try {
        switch (params.queryStoptimeMin) {
          case '0':
            params.queryStoptimeMax = '86400';
            break;
          case '86400':
            params.queryStoptimeMax = '259200';
            break;
          case '259200':
            params.queryStoptimeMax = null;
            break;
          default:
            break;
        }
