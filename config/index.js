...
const apiDomainMapping = {
  local: 'http://192.168.1.14:8080',
  test: 'http://zy.dtmobi.com:8080',
  prod: 'http://gps.dtmobi.com:8080',
};
const BUILD_MODE = process.argv[2] || 'test';
process.env.BUILD_MODE = BUILD_MODE;

const devApiDomain = 'http://120.78.82.60:8080';
// const devApiDomain = 'http://192.168.1.170:8080';
...
module.exports = {
  ...
  dev: {
    ...
    proxyTable: {
      ...
      // },
      '/new-gps-web/api': {
        target: `${devApiDomain}/new-gps-web/`,
        changeOrigin: true,
        pathRewrite: {
          '^/new-gps-web/api': '',
        },
